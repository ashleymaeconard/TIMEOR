           ...
           for fastq in ${dir}/*
               do
                   ...
                   ((i = i + 1))
                    ...
                    echo "/hisat2-2.1.0/./hisat2 -p ${NUM_PROCESSORS} --dta -x $genome -U $fastq -t --novel-splicesite-outfile $folderName/novel_splicesite --summary-file $folderName/summaryfile.txt -S $folderName/out.sam 2> $folderName/alignmentsummary.txt; samtools sort -O sam -T $folderName/out.sorted -o $folderName/out.sorted.sam $folderName/out.sam; samtools view -S -b $folderName/out.sorted.sam > $folderName/out.sorted.bam; rm -rf $folderName/out.sam $folderName/out.sorted.sam">> $COMMAND_SCRIPT
        ...
        # PAIRED END READS
            ...
            for R1 in ${dir}/*R1*
                do
                    ...
                    echo "/hisat2-2.1.0/./hisat2 -p ${NUM_PROCESSORS} --dta -x $genome -1 $R1 -2 $R2 -t --novel-splicesite-outfile $folderName/novel_splicesite --summary-file $folderName/summaryfile.txt -S $folderName/out.sam 2> $folderName/alignmentsummary.txt; samtools sort -O sam -T $folderName/out.sorted -o $folderName/out.sorted.sam $folderName/out.sam; samtools view -S -b $folderName/out.sorted.sam > $folderName/out.sorted.bam; rm -rf $folderName/out.sam $folderName/out.sorted.sam">> $COMMAND_SCRIPT            
                    echo "Outputting results to $folderName"
            done
       fi
    fi
